...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'AIOVTUE', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '雨是神的烟花', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://yybb.us', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, AIOVTUE', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '萌ICP备20259977号', // 备案号 闽ICP备XXXXXX
  BEI_AN_LINK: process.env.NEXT_PUBLIC_BEI_AN_LINK || 'https://icp.gov.moe/?keyword=20259977', // 备案查询链接，如果用了萌备等备案请在这里填写
